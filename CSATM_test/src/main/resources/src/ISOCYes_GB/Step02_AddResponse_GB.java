...
public static String xlsFilePath = System.getProperty("user.dir") + "\\src\\testdata\\testdata.xls";
	...
	//pricing
		@FindBy (xpath = ".//*[@id='FLD_ST_BILL_RT']" ) private WebElement ST_rate ;
	...
	public void login(){
		...
		wait1.until(ExpectedConditions.visibilityOf(Sign_in_to_CSA));
		...
		UsernameField.sendKeys(Excel.getCellValue(xlsFilePath, "Login", 8, 0));
		...
		PasswordField.clear();
		PasswordField.sendKeys(Excel.getCellValue(xlsFilePath, "Login", 8, 1));
		...
		wait01.until(ExpectedConditions.visibilityOf(CSA_search_tab));
		
		CSA_search_tab.click();
		
		Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save("C:\\Administrator\\T&M\\2018\\2019\\Selenium\\ISOC\\GB\\Core\\");
		
		WebDriverWait wait012 = new WebDriverWait(driver, 160);
		wait012.until(ExpectedConditions.visibilityOf(Req_Num_field));
		...
		wait02.until(ExpectedConditions.visibilityOf(Request_Number_link));
	...
	public void FillRespdetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String rate) 
	{
		...
		Resp_Attachment.sendKeys("C:\\Users\\IBM_ADMIN\\Desktop\\attachment.txt");
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
	...
	{
		Submit_responses.click();
		//Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save("C:\\Administrator\\T&M\\August FP\\Regression\\Recall_GB\\Core\\GB\\");
		/* code to capture screenshot */
		Shutterbug.shootPage(driver, ScrollStrategy.BOTH_DIRECTIONS).save("C:\\Administrator\\T&M\\2018\\2019\\Selenium\\ISOC\\GB\\Core\\");
	}
