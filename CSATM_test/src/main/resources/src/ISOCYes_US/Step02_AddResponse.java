...
public static String xlsFilePath = System.getProperty("user.dir") + "\\src\\testdata\\testdata.xls";
	...
	public void login(){
		...
		wait0.until(ExpectedConditions.visibilityOf(username));
		username.clear();
		username.sendKeys(Excel.getCellValue(xlsFilePath, "Login", 2, 0));
		
		pwd.clear();
		pwd.sendKeys(Excel.getCellValue(xlsFilePath, "Login", 2, 1));
